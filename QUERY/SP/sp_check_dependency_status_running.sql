...
CREATE OR REPLACE PROCEDURE `sp_dap.sp_check_dependency_status_running`(V_JOB_TYPE STRING, V_JOB_NAME STRING, V_PROJECT_ID STRING, V_DATASET_ID STRING, V_TARGET_TABLE STRING, V_EXECUTION_DATE DATE, V_OMT_JOB_DEPENDENCY_TABLE_NAME STRING, V_OMT_PROCESS_LOG_TABLE_NAME STRING)
BEGIN
