...
from DATA.operator.dap.function_sts_job_bd_tableau_daily import Function
...
AIRFLOW_VAR_DAP_DAG_ID = "sts_job_bd_tableau_daily"
AIRFLOW_VAR_DAP_DAG_DESCRIPTION = "Cloudera BD_TABLEAU to BQ DM Daily"
AIRFLOW_VAR_DAP_DAG_ALIAS = 'sts_job_bd_tableau_daily'
AIRFLOW_VAR_DAP_DAG_PATH = '/DATA/config/dap/sts_job_bd_tableau_daily/'
...
with DAG(AIRFLOW_VAR_DAP_DAG_ID
    ...
    , catchup=False
    , tags=["STS","DAILY","BD_TABLEAU","DAP"]) as AIRFLOW_VAR_DAP_DAG_ALIAS:
